...
CREATE TABLE IF NOT EXISTS T_USER (
    ...
    USER_CMOD    VARCHAR(60) NOT NULL DEFAULT 'Desc', #Modelo carro
    USER_CMAR    VARCHAR(60) NOT NULL DEFAULT 'Desc', #Marca carro
    USER_CANO    VARCHAR(10) NOT NULL DEFAULT '2000', #Ano
    USER_CKML    DECIMAL(4,2) NOT NULL DEFAULT '0.0', #KM por litro
