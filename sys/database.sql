...
INSERT INTO T_USER (USER_CPF, USER_NOME, USER_PASS)
VALUES (01625439210, 'Felipe L.', 'ODgzODczMTM=');
INSERT INTO T_USER (USER_CPF, USER_NOME, USER_PASS)
VALUES (58074317315, 'Robson', 'NTgwNzQzMTczMTU=');
SELECT * FROM T_USER;
...
CREATE TABLE IF NOT EXISTS T_MENSALIDADES (
    ...
    MENS_USER BIGINT UNSIGNED ZEROFILL NOT NULL, #ID User
