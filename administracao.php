...
<html lang="pt-BR">
    ...
    <body>
        ...
        <main  style="float: left;width: 100%; padding: 20px;">
            <button type="button" onclick="window.location.href='admin/avisos.php';"style="float: left;width: 100%; margin-bottom: 10px;" class="btn btn-secondary btn-lg">Avisos</button>
